...
/**
 * Contribuyente Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class Contribuyente implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'contribuyente';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['rfc'] === null) {
            $invalid_properties[] = "'rfc' can't be null";
        }
        if ($this->container['nombre'] === null) {
            $invalid_properties[] = "'nombre' can't be null";
        }
