...
class Item implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['descripcion'] === null) {
            $invalid_properties[] = "'descripcion' can't be null";
        }
        if ($this->container['precio_unitario'] === null) {
            $invalid_properties[] = "'precio_unitario' can't be null";
        }
        if ($this->container['cantidad'] === null) {
            $invalid_properties[] = "'cantidad' can't be null";
        }
    ...
    /**
     * Sets descripcion
     * @param string $descripcion Descripción del item a facturar
     * @return $this
     */
     ...
     * @param float $precio_unitario Precio unitario del item facturado
     * @return $this
     */
    ...
    /**
     * Sets cantidad
     * @param int $cantidad Cantidad de items a facturar
     * @return $this
     */
    ...
    /**
     * Sets total
     * @param float $total Monto total del item facturado
     * @return $this
     */
